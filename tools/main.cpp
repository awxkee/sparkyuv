...
//  saveVectorToFile(encoded, "jpeg.jpeg");
  ...
  bench(1, ANSI_COLOR_GREEN, "RGBA -> YUV420", [&]() {
    sparkyuv::RGBA8ToYCgCo444P8(rgbaData.data(), rgbaStride, width, height,
  ...
  bench(1, ANSI_COLOR_GREEN, "YUV420 -> RGB", [&]() {
    sparkyuv::YCgCo444P8ToRGBA8(rgbaData.data(), rgbaStride, width, height,
                                yPlane.data(), yPlaneStride,
                                uPlane.data(), uvPlaneStride,
                                vPlane.data(), uvPlaneStride, sparkyuv::YUV_RANGE_PC);
  });
...
//
//  sparkyuv::WideRGBA8To12(rgbaData.data(),
...
//    sparkyuv::RGBA12ToYCgCo444P12(reinterpret_cast<uint16_t *>(rgba16Data.data()),
//                                inWidth * 4 * sizeof(uint16_t),
//                                inWidth,
//                                inHeight,
...
//                                uvPlaneStride16 * sizeof(uint16_t), sparkyuv::YUV_RANGE_PC);
//  });
//  bench(1, ANSI_COLOR_BLUE, "RGBA10 -> YUV444 P10", [&] () {
...
//    sparkyuv::YCgCo444P12ToRGBA12(reinterpret_cast<uint16_t *>(rgba16Data.data()),
//                                inWidth * 4 * sizeof(uint16_t),
//                                inWidth,
//                                inHeight,
//                                reinterpret_cast<uint16_t *>(yPlane16.data()),
...
//
//  sparkyuv::SaturateRGBA12To8(reinterpret_cast<uint16_t *>(rgba16Data.data()), inWidth * 4 * sizeof(uint16_t),
