...
CHANNEL_XXX_REFORMAT_TO_F16_DECLARATION(Channel, Channel, uint8_t, CHANNEL)
...
CHANNEL_XXX_REFORMAT16_TO_F16_DECLARATION(Channel16, uint16_t, CHANNEL)
...
CHANNEL_XXX_REFORMAT_F16_TO_U_DECLARATION(Channel, Channel, uint8_t, CHANNEL)
...
CHANNEL_XXX_REFORMAT_F16_TO_U_DECLARATION(Channel16, uint16_t, CHANNEL)
