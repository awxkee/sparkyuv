...
#define CHANNEL_XXX_REFORMAT_DECLARATION_F16(srcPixelType, dstPixelType) HWY_EXPORT(srcPixelType##F16To##dstPixelType##F16HWY);
...
CHANNEL_REFORMAT_DECLARATION_F16_E(RGB, RGBA)
CHANNEL_REFORMAT_DECLARATION_F16_E(BGR, BGRA)
CHANNEL_REFORMAT_DECLARATION_F16_E(BGR, ABGR)
CHANNEL_REFORMAT_DECLARATION_F16_E(RGB, ARGB)

CHANNEL_REFORMAT_DECLARATION_F16_E(RGBA, RGB)
CHANNEL_REFORMAT_DECLARATION_F16_E(BGRA, BGR)
CHANNEL_REFORMAT_DECLARATION_F16_E(ABGR, BGR)
CHANNEL_REFORMAT_DECLARATION_F16_E(ARGB, RGB)

CHANNEL_REFORMAT_DECLARATION_F16_E(BGRA, RGB)
CHANNEL_REFORMAT_DECLARATION_F16_E(RGBA, BGR)
CHANNEL_REFORMAT_DECLARATION_F16_E(ABGR, RGB)
CHANNEL_REFORMAT_DECLARATION_F16_E(ARGB, BGR)

CHANNEL_REFORMAT_DECLARATION_F16_E(BGRA, RGBA)
CHANNEL_REFORMAT_DECLARATION_F16_E(BGRA, ARGB)
CHANNEL_REFORMAT_DECLARATION_F16_E(RGBA, ABGR)
CHANNEL_REFORMAT_DECLARATION_F16_E(ABGR, RGBA)
CHANNEL_REFORMAT_DECLARATION_F16_E(ARGB, BGRA)

#undef CHANNEL_REFORMAT_DECLARATION_F16_E
...
CHANNEL_XXX_REFORMAT16_TO_F16_DECLARATION_E(RGB16, RGB, uint16_t)
CHANNEL_XXX_REFORMAT16_TO_F16_DECLARATION_E(Channel16, Channel, uint16_t)
...
CHANNEL_XXX_REFORMAT_F16_TO_U16_DECLARATION_E(RGB16, RGB, uint16_t)
