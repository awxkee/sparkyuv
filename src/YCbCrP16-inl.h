...
#if defined(SPARKYUV__YUV444P16_INL_H) == defined(HWY_TARGET_TOGGLE)
#ifdef SPARKYUV__YUV444P16_INL_H
#undef SPARKYUV__YUV444P16_INL_H
#else
#define SPARKYUV__YUV444P16_INL_H
#endif
...
void Pixel16ToYUV444HWY(const uint16_t *SPARKYUV_RESTRICT src, const uint32_t srcStride,
...
#define XXXXToYUV444PHWY_DECLARATION_R(pixelType, bit, yuvname, chroma) \
        void pixelType##To##yuvname##P##bit##HWY(const uint16_t *SPARKYUV_RESTRICT src, const uint32_t srcStride,\
                                            ...
                                            uint16_t *SPARKYUV_RESTRICT vPlane, const uint32_t vStride,\
                                            const float kr, const float kb, const SparkYuvColorRange colorRange) {\
          Pixel16ToYUV444HWY<sparkyuv::PIXEL_##pixelType, chroma, bit>(src, srcStride, width, height,\
                                                          yPlane, yStride, uPlane, uStride, vPlane, vStride, kr, kb, colorRange);\
        }

XXXXToYUV444PHWY_DECLARATION_R(RGBA, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
XXXXToYUV444PHWY_DECLARATION_R(RGB, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
#if SPARKYUV_FULL_CHANNELS
XXXXToYUV444PHWY_DECLARATION_R(ARGB, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
XXXXToYUV444PHWY_DECLARATION_R(ABGR, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
XXXXToYUV444PHWY_DECLARATION_R(BGRA, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
XXXXToYUV444PHWY_DECLARATION_R(BGR, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
#endif

XXXXToYUV444PHWY_DECLARATION_R(RGBA, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
XXXXToYUV444PHWY_DECLARATION_R(RGB, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
#if SPARKYUV_FULL_CHANNELS
XXXXToYUV444PHWY_DECLARATION_R(ARGB, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
XXXXToYUV444PHWY_DECLARATION_R(ABGR, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
XXXXToYUV444PHWY_DECLARATION_R(BGRA, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
XXXXToYUV444PHWY_DECLARATION_R(BGR, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
#endif

XXXXToYUV444PHWY_DECLARATION_R(RGBA, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
XXXXToYUV444PHWY_DECLARATION_R(RGB, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
#if SPARKYUV_FULL_CHANNELS
XXXXToYUV444PHWY_DECLARATION_R(ARGB, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
XXXXToYUV444PHWY_DECLARATION_R(ABGR, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
XXXXToYUV444PHWY_DECLARATION_R(BGRA, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
XXXXToYUV444PHWY_DECLARATION_R(BGR, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
#endif

XXXXToYUV444PHWY_DECLARATION_R(RGBA, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
XXXXToYUV444PHWY_DECLARATION_R(RGB, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
#if SPARKYUV_FULL_CHANNELS
XXXXToYUV444PHWY_DECLARATION_R(ARGB, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
XXXXToYUV444PHWY_DECLARATION_R(ABGR, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
XXXXToYUV444PHWY_DECLARATION_R(BGRA, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
XXXXToYUV444PHWY_DECLARATION_R(BGR, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
#endif

XXXXToYUV444PHWY_DECLARATION_R(RGBA, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
XXXXToYUV444PHWY_DECLARATION_R(RGB, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
#if SPARKYUV_FULL_CHANNELS
XXXXToYUV444PHWY_DECLARATION_R(ARGB, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
XXXXToYUV444PHWY_DECLARATION_R(ABGR, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
XXXXToYUV444PHWY_DECLARATION_R(BGRA, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
XXXXToYUV444PHWY_DECLARATION_R(BGR, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
#endif

XXXXToYUV444PHWY_DECLARATION_R(RGBA, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
XXXXToYUV444PHWY_DECLARATION_R(RGB, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
#if SPARKYUV_FULL_CHANNELS
XXXXToYUV444PHWY_DECLARATION_R(ARGB, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
XXXXToYUV444PHWY_DECLARATION_R(ABGR, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
XXXXToYUV444PHWY_DECLARATION_R(BGRA, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
XXXXToYUV444PHWY_DECLARATION_R(BGR, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
#endif

#undef XXXXToYUV444PHWY_DECLARATION_R

template<SparkYuvDefaultPixelType PixelType = sparkyuv::PIXEL_RGBA, SparkYuvChromaSubsample chromaSubsample, int bitDepth>
void YUV444P16ToXRGB(uint16_t *SPARKYUV_RESTRICT rgbaData, const uint32_t dstStride,
                     const uint32_t width, const uint32_t height,
...
#define YUV444PXToXXXX_DECLARATION_R(pixelType, bit, yuvname, chroma) \
    void yuvname##P##bit##To##pixelType##HWY(uint16_t *SPARKYUV_RESTRICT src, const uint32_t srcStride,\
                                             ...
                                             const uint16_t *SPARKYUV_RESTRICT vPlane, const uint32_t vStride,\
                                             const float kr, const float kb, const SparkYuvColorRange colorRange) {\
                                             YUV444P16ToXRGB<sparkyuv::PIXEL_##pixelType, chroma, bit>(src, srcStride, width, height,\
                                                                                        yPlane, yStride, uPlane, uStride, vPlane, vStride, \
                                                                                        kr, kb, colorRange);\
                                           }

YUV444PXToXXXX_DECLARATION_R(RGBA, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
YUV444PXToXXXX_DECLARATION_R(RGB, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
#if SPARKYUV_FULL_CHANNELS
YUV444PXToXXXX_DECLARATION_R(ARGB, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
YUV444PXToXXXX_DECLARATION_R(ABGR, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
YUV444PXToXXXX_DECLARATION_R(BGRA, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
YUV444PXToXXXX_DECLARATION_R(BGR, 10, YUV444, sparkyuv::YUV_SAMPLE_444)
#endif
YUV444PXToXXXX_DECLARATION_R(RGBA, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
YUV444PXToXXXX_DECLARATION_R(RGB, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
#if SPARKYUV_FULL_CHANNELS
YUV444PXToXXXX_DECLARATION_R(ARGB, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
YUV444PXToXXXX_DECLARATION_R(ABGR, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
YUV444PXToXXXX_DECLARATION_R(BGRA, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
YUV444PXToXXXX_DECLARATION_R(BGR, 10, YUV422, sparkyuv::YUV_SAMPLE_422)
#endif
YUV444PXToXXXX_DECLARATION_R(RGBA, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
YUV444PXToXXXX_DECLARATION_R(RGB, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
#if SPARKYUV_FULL_CHANNELS
YUV444PXToXXXX_DECLARATION_R(ARGB, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
YUV444PXToXXXX_DECLARATION_R(ABGR, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
YUV444PXToXXXX_DECLARATION_R(BGRA, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
YUV444PXToXXXX_DECLARATION_R(BGR, 10, YUV420, sparkyuv::YUV_SAMPLE_420)
#endif

YUV444PXToXXXX_DECLARATION_R(RGBA, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
YUV444PXToXXXX_DECLARATION_R(RGB, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
#if SPARKYUV_FULL_CHANNELS
YUV444PXToXXXX_DECLARATION_R(ARGB, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
YUV444PXToXXXX_DECLARATION_R(ABGR, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
YUV444PXToXXXX_DECLARATION_R(BGRA, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
YUV444PXToXXXX_DECLARATION_R(BGR, 12, YUV444, sparkyuv::YUV_SAMPLE_444)
#endif

YUV444PXToXXXX_DECLARATION_R(RGBA, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
YUV444PXToXXXX_DECLARATION_R(RGB, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
#if SPARKYUV_FULL_CHANNELS
YUV444PXToXXXX_DECLARATION_R(ARGB, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
YUV444PXToXXXX_DECLARATION_R(ABGR, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
YUV444PXToXXXX_DECLARATION_R(BGRA, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
YUV444PXToXXXX_DECLARATION_R(BGR, 12, YUV422, sparkyuv::YUV_SAMPLE_422)
#endif
YUV444PXToXXXX_DECLARATION_R(RGBA, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
YUV444PXToXXXX_DECLARATION_R(RGB, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
#if SPARKYUV_FULL_CHANNELS
YUV444PXToXXXX_DECLARATION_R(ARGB, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
YUV444PXToXXXX_DECLARATION_R(ABGR, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
YUV444PXToXXXX_DECLARATION_R(BGRA, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
YUV444PXToXXXX_DECLARATION_R(BGR, 12, YUV420, sparkyuv::YUV_SAMPLE_420)
#endif
