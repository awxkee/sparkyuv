...
#if defined(SPARKYUV__YCbCr444P16_INL_H) == defined(HWY_TARGET_TOGGLE)
#ifdef SPARKYUV__YCbCr444P16_INL_H
#undef SPARKYUV__YCbCr444P16_INL_H
#else
#define SPARKYUV__YCbCr444P16_INL_H
#endif
