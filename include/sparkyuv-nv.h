...
void RGBAToNV21(const uint8_t *src,
                uint32_t dstStride,
                uint32_t width,
                uint32_t height,
                uint8_t *ySrc,
...
void RGBAToNV12(const uint8_t *src,
                uint32_t dstStride,
                uint32_t width,
                uint32_t height,
                uint8_t *ySrc,
...
void RGBAToNV16(const uint8_t *src,
                uint32_t dstStride,
                uint32_t width,
                uint32_t height,
                uint8_t *ySrc,
...
void RGBAToNV61(const uint8_t *src,
                uint32_t dstStride,
                uint32_t width,
                uint32_t height,
                uint8_t *ySrc,
...
void RGBAToNV24(const uint8_t *src,
                uint32_t dstStride,
                uint32_t width,
                uint32_t height,
                uint8_t *ySrc,
...
void RGBAToNV42(const uint8_t *src,
                uint32_t dstStride,
                uint32_t width,
                uint32_t height,
                uint8_t *ySrc,
